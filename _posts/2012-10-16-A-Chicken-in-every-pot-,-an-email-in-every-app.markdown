...
disableolark: true
loadscript: "<script type=\"text/javascript\">var _hmc = _hmc || [];_hmc.push(['app', '024d55ddd11340ca89cc5bd13705fe0d']);_hmc.push(['settings', { }]);_hmc.push(['input', { 'placeholder': false, 'height': '20px' }]);_hmc.push(['title','Hipmob Email Demonstration']);(function() { var hm = document.createElement('script'); hm.type = 'text/javascript'; hm.async = true; hm.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'hipmob.s3.amazonaws.com/hipmobchat.min.js'; var b = document.getElementsByTagName('body')[0]; b.appendChild(hm); })();</script>"
---
...
Here at [Hipmob](https://www.hipmob.com "Hipmob"), we provide live chat services: you sign up with us, we give you a code, you download our libraries for <a href="http://www.hipmob.com/documentation/ios">iOS</a> and <a href="http://www.hipmob.com/documentation/android">Android</a>, you integrate it into your app, and you can then talk to your users, figure out what they want and what problems they are having, and make them happy. No servers, no extra steps or code to write, wherever the users are, you get to focus on what you do well. However, we're trying to transform live chat from something that just gets used when someone has a problem to an active channel you can use to drive value for your customer (and for you!). 
